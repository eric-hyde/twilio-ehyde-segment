import {
  to = segment_warehouse.id-gPrGfMxVxKwDpmPQwzccx5
  id = "gPrGfMxVxKwDpmPQwzccx5"
}

resource "segment_warehouse" "id-gPrGfMxVxKwDpmPQwzccx5" {
  enabled = true
  metadata = {
    id = "55d3d3aea3c"
  }
  name = "heroku-postgres-destination"
  settings = jsonencode({
